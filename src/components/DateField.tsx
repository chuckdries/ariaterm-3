...
const segmentStyles = tv({
  base: 'inline p-0.5 type-literal:px-0 rounded outline outline-0 forced-color-adjust-none caret-transparent text-primary-800 dark:text-primary-200 forced-colors:text-[ButtonText]',
  variants: {
    isPlaceholder: {
      true: 'text-primary-600 dark:text-primary-400 italic'
    },
    isDisabled: {
      true: 'text-primary-200 dark:text-primary-600 forced-colors:text-[primaryText]'
    },
    isFocused: {
