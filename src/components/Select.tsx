...
const styles = tv({
  extend: focusRing,
  base: 'flex items-center text-start gap-4 w-full cursor-default border border-black/10 dark:border-white/10 shadow-[inset_0_1px_0_0_rgba(255,255,255,0.1)] dark:shadow-none pl-3 pr-2 py-2 min-w-[150px] bg-gray-50 dark:bg-zinc-700',
  variants: {
    isDisabled: {
